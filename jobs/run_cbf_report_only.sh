...
REPORT_NOTEBOOK="${REPORT_DIR}/cbf_report_executed.ipynb"
REPORT_HTML="${REPORT_DIR}/cbf_report.html"

mkdir -p "${REPORT_DIR}"

echo "Starting CBF report-only job"
