...
from autoencodix.visualize._imagix3d_visualizer import Imagix3DVisualizer
...
class Imagix3D(BasePipeline):
    ...
    def __init__(
        ...
        model_type: Type[BaseAutoencoder] = VolumeVAEArchitecture,
        ...
        config: Optional[Imagix3DConfig] = None,
    ) -> None:
        """Initialize the Imagix3D pipeline with customizable components.
        ...
        """
        self._default_config = Imagix3DConfig()
        super().__init__(
            data=data,
